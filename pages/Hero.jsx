...
Industry-leading technology{' '}</h1>
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative ">cloud-based </span>
        </span>{' '}
     ...
     School  management system
      ...
      A cloud-based school management system designed with you in mind.
      Managing any area of school life just got easier and paperless wherever you are.
