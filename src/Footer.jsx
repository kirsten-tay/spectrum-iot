  ...
  return (
    <footer className="bg-slate-900">
      <Container>
        <div className="py-16">
          <nav className="mt-10 text-sm" aria-label="quick links">
            ...
            <ul className="flex mx-auto justify-center space-x-6 -my-1 mt-16 grid max-w-3xl grid-cols-1 gap-6 sm:gap-8 lg:mt-20 lg:max-w-none  lg:grid-cols-3">
              ...
              <li>
                <Link href="#features">
                  <a className="rounded-lg px-2 py-1 text-white hover:bg-slate-100 hover:text-slate-900">
                    About Us
                  </a>
        ...
        <div className="flex flex-col items-center border-t border-white py-10 sm:flex-row-reverse sm:justify-between">
          <p className="mt-6 text-sm text-white sm:mt-0">
        
             &copy; spectrumFoundation {new Date().getFullYear()}.All rights
            reserved.
          </p>
          <div className="flex space-x-6">
            <Link href="#">
              <a className="group">
                ...
                <svg
                  aria-hidden="true"
                  className="h-6 w-6 fill-white group-hover:fill-slate-700"
                >
            ...
            <p className="text-white">Spectrum</p>
          </div>
